...
file_counts = {'jpg':10,"txt":14,"csv":2} # create
print(file_counts)
print(file_counts["txt"])
print("jpg" in file_counts) 
print("html" in file_counts)
file_counts["cv"]=8 # add or insert
print(file_counts)
file_counts["csv"]=18 # change or replace
print(file_counts)
del file_counts["csv"] # delete or remove
print(file_counts)
...
print(count_letters("aaaaaaaaaaaadafddfsdfsfse"))
# 
